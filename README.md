...
- **Knowledge** — a structured index (`knowledge/index.md`) pointing to authoritative vendor documentation (Microsoft, VMware, Veeam, OpenStack, Linux/Ubuntu/Red Hat, Network vendors, PostgreSQL, Ansible), with a defined place for internal organizational standards to sit alongside it.
